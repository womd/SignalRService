...
namespace SignalRService.Utils
{
    public static class CultureHelper
    {
        ...
        //  private static List<string> Cultures { get { } set { } }

        //    = new List<string> 
        //{
        //    //de
        //    "de-DE", // first culture is the DEFAULT
        //    "en-US", // us english culture 
        //    "ro-RO" // romanian
        //};
        ...
        public static List<string> Cultures
        {
            get
            {
                if (_cultures == null || _cultures.Count <= 1)
                {
        ...
        {
            return Cultures.First(); // return Default culture
        }

        public static string GetUsCulture()
        {
            return "en-US";
        }
        ...
        public static string GetCountryCulture(string name)
        {
